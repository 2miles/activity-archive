...
def parse_iso_datetime(dt_str: Any) -> Optional[datetime]:
    """
    Parse ISO datetime strings from Strava JSON.

    Supports:
      - 2026-03-24T04:04:59Z
      - 2026-03-23T21:04:59
      - 2026-03-24T04:04:59+00:00
    """
...
def activity_start_local(activity: dict) -> Optional[datetime]:
    """Prefer start_date_local, fall back to start_date."""
    return parse_iso_datetime(activity.get("start_date_local")) or parse_iso_datetime(
        activity.get("start_date")
    )
